...
if __name__ == '__main__':
    ...
    humanoid = "smplx_humanoid_fingers"
    ...
    for f in all_files:
        ...
        if skill in list(candidates.keys()) and seq_name in list(candidates[skill].keys()):
            ...
            box_trans[start : end + 1] = (
                (motion.global_translation[start : end + 1, motion.skeleton_tree.index("L_Wrist")] + motion.global_translation[start : end + 1, motion.skeleton_tree.index("R_Wrist")]) / 2
            ).numpy()
            ...
            vec = (motion.global_translation[start : end + 1, motion.skeleton_tree.index("R_Wrist")] - motion.global_translation[start : end + 1, motion.skeleton_tree.index("L_Wrist")])
